...
5. На сайте GitHub заходим в данный удаленный репозиторий и нажимаем кнопку `create pull request`. При этом нужно выбрать ветку в которой мы работали (изначально задана ветка main). При желании можно добавиь комментарий.
